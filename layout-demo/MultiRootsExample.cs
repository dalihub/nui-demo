...
namespace LayoutDemo
{
    ...
    class MultiRootsExample : Example
    {
        ...
        public override void Create()
        {
            ...
            LinearLayoutEx verticalLayout = new LinearLayoutEx();
            verticalLayout.LinearOrientation = LinearLayoutEx.Orientation.Vertical;

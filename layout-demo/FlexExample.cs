...
namespace LayoutDemo
{
    class FlexExample : Example
    {
        ...
        public override void Create()
        {
            ...
            wrapButton.SetProperty(PushButton.Property.UNSELECTED_ICON, new PropertyValue("./res/images/icon-replace.png"));
            wrapButton.SetProperty(PushButton.Property.SELECTED_ICON, new PropertyValue("./res/images/icon-replace-selected.png"));
            ...
            justifyButton.SetProperty(PushButton.Property.UNSELECTED_ICON, new PropertyValue("./res/images/icon-item-view-layout-grid.png"));
            justifyButton.SetProperty(PushButton.Property.SELECTED_ICON, new PropertyValue("./res/images/icon-item-view-layout-grid-selected.png"));

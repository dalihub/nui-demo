...
class MultipleWindowExample : NUIApplication
{
    ...
    protected override void OnCreate()
    {
        ...
        mainWindow.WindowSize = new Size2D(1290, 200);
        ...
        for (int i = 0; i < textButton.Length; i++)
        {
          ...
          {
              case 0:
                  textButton[i]._button.TouchEvent += OnButton1Touched;
                  break;
              case 1: 
                  textButton[i]._button.TouchEvent += OnButton2Touched;
                  break;
              case 2: 
                  textButton[i]._button.TouchEvent += OnButton3Touched;
                  break;
              case 3: 
                  textButton[i]._button.TouchEvent += OnButton4Touched;
                  break;
              default:
                  break;
          }
    ...
    public bool OnButton1Touched(object sender, View.TouchEventArgs e)
    {
    ...
    public bool OnButton2Touched(object sender, View.TouchEventArgs e)
    {
        if (e.Touch.GetState(0) == PointStateType.Up)
        {
          _focusManager.SetCurrentFocusView(textButton[1]._button);
    ...
    public bool OnButton3Touched(object sender, View.TouchEventArgs e)
    {
        if (e.Touch.GetState(0) == PointStateType.Up)
        {
          _focusManager.SetCurrentFocusView(textButton[2]._button);
    ...
    public bool OnButton4Touched(object sender, View.TouchEventArgs e)
    {
        if (e.Touch.GetState(0) == PointStateType.Up)
        {
          _focusManager.SetCurrentFocusView(textButton[3]._button);
...
//        var view = new View()
        var view = new ImageView("./res/images/background-3.jpg")
        {
          ...
          HeightSpecification = LayoutParamPolicies.MatchParent,
//          BackgroundColor = new Color(0.61f, 0.59f, 0.64f, 1.0f),
//          Background = imageVisual.OutputVisualMap,
//          Background = CreateGradientVisual(new Vector4(0.31f, 0.31f, 0.83f, 1.0f), new Vector4(0.57f, 0.91f, 0.89f, 1.0f)).OutputVisualMap,
        };
    ...
    public void ShowHideWindowTest()
    {
      ...
      {          
        ...
        rotateAnimation.SetDuration(2.0f);
        rotateAnimation.Looping = true;
        rotateAnimation.AnimateTo(image, "Orientation", new Rotation(new Radian(new Degree(180.0f)), PositionAxis.Z), 0, 1000);
        rotateAnimation.AnimateTo(image, "Orientation", new Rotation(new Radian(new Degree(360.0f)), PositionAxis.Z), 1000, 2000);
    ...
    static void Main(string[] args)
    {
        ...
        MultipleWindowExample example = new MultipleWindowExample();
        example.Run(args);
    }
}

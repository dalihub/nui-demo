...
namespace Silk
{
    ...
    class Demo : NUIApplication
    {
        ...
        public static ImageView CreateImageView(String url, Size2D size)
        {
        ...
        public static View CreateReviewEntry(string thumbnailFilename)
        {
            ...
            View thumbnail = CreateImageView(thumbnailFilename, new Size2D(60,60));
            entry.Add(thumbnail);
        ...
        private void PopulateContentStore()
        {
            ...
            foreach (string category in titleList)
            {
                ...
                foreach ( string file in files)
                {
                    ...
                    ImageView imageView = CreateImageView(file, new Size2D(400,(int)Math.Ceiling(FrameHeight*ItemImageRatioToFrameHeight)));
                    categoryContent.Add(imageView);
                }

                for(var i =0; i<=1; i++)
                {
                    categoryContent.Add(CreateReviewEntry(files[0]));
                }

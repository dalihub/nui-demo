...
namespace Silk
{
    ...
    class Demo : NUIApplication
    {
        ...
        private List<string> titleList = new List<string>{ "categoryA", "categoryB", "categoryC", "categoryD" };
        ...
        private void PopulateContentStore()
        {
            ...
            foreach (string category in titleList)
            {
                ...
                foreach ( string file in files)
                {
                    ...
                    ImageView imageView = CreateChildImageView(file, new Size2D(400, 400));
                ...
                switch( e.Key.KeyPressedName )
                {
                    case "Left" :
                    {
                        if (!listView && currentView <3)
                        {
                            ...
                            //scrollAnimation.AnimateTo(contentArea, "PositionX", contentArea.PositionX - 480,
                            //0,
                            //256,
                    ...
                    case "Up" :
                    {
                        ...
                        //scrollAnimation.AnimateTo(contentArea, "PositionY", 300.0f,
                        //256,
                        //400,
                        //new AlphaFunction(AlphaFunction.BuiltinFunctions.EaseIn) );
                    ...
                    case "Down" :
                    {
                        ...
                        //scrollAnimation.AnimateTo(contentArea, "PositionY", 800.0f,
                        //0,
                        //256,

...
public class CircularTextExample : NUIApplication
{
    ...
    private View root;
    static string resPath = Tizen.Applications.Application.Current.DirectoryInfo.Resource;
    static string IMAGE1 = resPath + "application-icon-1.png";
    static string IMAGE2 = resPath + "application-icon-6.png";
